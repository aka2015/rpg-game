...
public readonly record struct QuestTurnedInEvent(string QuestId) : IGameEvent;
public readonly record struct PlayerLevelUpEvent(int Level) : IGameEvent;
public readonly record struct PlayerStatsChangedEvent(int CurrentHp, int MaxHp, int CurrentStamina, int MaxStamina, int Level, int Gold) : IGameEvent;
